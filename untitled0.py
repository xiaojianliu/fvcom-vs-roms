...
from untitled1 import get_drifter_track,get_fvcom,get_roms,calculate_SD,drifterhr
######## Hard codes ##########
...
csvfile = file('drifter_vs_model use hourly data1.csv', 'wb')
